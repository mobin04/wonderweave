    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(date)
          });
        case 3:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          url = type === 'add-review' ? "/api/v1/tours/".concat(tourId, "/reviews") : "/api/v1/reviews/".concat(reviewId);
          _context.next = 5;
          return (0, _axios.default)({
            method: method,
            url: url,
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          if (type === 'create') {
            ...
            method = 'PATCH', url = "/api/v1/tours/".concat(tourId, "}");
          }
          _context.next = 4;
          return (0, _axios.default)({
            method: method,
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "/api/v1/tours/".concat(tourId, "/add-lead-guide"),
            data: {
              guideId: guideId
            }
          });
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "/api/v1/tours/".concat(tourId, "/remove-guide"),
            data: {
              guideId: guideId
            }
          });
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              guideId = selectLeadGuide.value; // console.log(`guide ID:${guideId} | tour ID: ${tourId}`);
              _context6.next = 7;
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              tourId = tourSection.querySelector('.tour-header').getAttribute('data-tourId'); // console.log(`GUIDE ID::${guideId} | TOUR ID::${tourId}`);
              _context7.next = 6;
