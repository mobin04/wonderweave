...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9iaW44MTEzIiwiYSI6ImNtN215YTU1MDB1encyanNhZDhwMmlsdmsifQ.okBjamSAp5aitkVTMbbWzA'; // INITIALIZING THE MAP
  ...
  var bounds = new mapboxgl.LngLatBounds(); // LOOPING THROUGH LOCATIONS
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)(res.data.status, 'Data Updated Successfully!');
            window.setTimeout(function () {
              location.assign('/me');
            }, 1500);
          }
...
var userDataForm = document.querySelector('.form-user-data'); // MAP BOX
