...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9iaW44MTEzIiwiYSI6ImNtN215YTU1MDB1encyanNhZDhwMmlsdmsifQ.okBjamSAp5aitkVTMbbWzA';

  // INITIALIZING THE MAP
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/mobin8113/cm7n5rxuq00fe01sbg53b4iq9',
    // style URL
    scrollZoom: false
  ...
  locations.forEach(function (loc) {
    // Create marker
    var el = document.createElement('div'); // Creates a new <div> element in the DOM.
    el.className = 'marker'; //  Gives it a CSS class (marker) to style it.

    // ADDING THE MARKER TO THE MAP
    new mapboxgl.Marker({
      element: el,
      // Uses the created <div> as the marker
    ...
    .setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")) // Adds tour info inside the popup
...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
    var loginBtn, spinner, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          loginBtn = document.querySelector('.login-btn');
          spinner = document.querySelector('.spinner'); // Show spinner and disable button
...
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */ // IMPLEMENT UPDATE USER DATA
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)(res.data.status, 'Verification mail successfully sent to your email');
            window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"resendMail.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var resendVerification = exports.resendVerification = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)(res.data.status, 'Verification mail send successfully! Please check your email.');
            window.setTimeout(function () {
              location.assign(res.data.redirect);
            }, 1500);
          }
  ...
  return function resendVerification(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51R02DPAXlJ3kcN71UXcNEYoBkQh1VgmYyAUkTPoo7qOQ86b6KSaRLIPx5B0FMZjwB4WlyVYfjNhUx8l87bk5aT6800oSH6K4eS');
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, date) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(date)
          });
        case 3:
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"bookingConfirm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.bookingConfirm = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var bookingConfirm = exports.bookingConfirm = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)(res.data.status, 'Booking Successful!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
  ...
  return function bookingConfirm(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.manageReview = exports.deleteReview = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var manageReview = exports.manageReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, reviewId, tourId, rating, review) {
    var method, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          method = type === 'add-review' ? 'POST' : 'PATCH';
          url = type === 'add-review' ? "http://127.0.0.1:8000/api/v1/tours/".concat(tourId, "/reviews") : "http://127.0.0.1:8000/api/v1/reviews/".concat(reviewId);
          _context.next = 5;
          return (0, _axios.default)({
            method: method,
            url: url,
        ...
        case 5:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)(res.data.status, type === 'add-review' ? 'Review created successfully' : 'Review updated successfully');
            window.setTimeout(function () {
  ...
  return function manageReview(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
var deleteReview = exports.deleteReview = /*#__PURE__*/function () {
  ...
  return function deleteReview(_x6) {
    return _ref2.apply(this, arguments);
  };
}();
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var manageTour = exports.manageTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type, tourId) {
    var method, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          if (type === 'create') {
            ...
            method = 'PATCH', url = "http://127.0.0.1:8000/api/v1/tours/".concat(tourId, "}");
          }
          _context.next = 4;
          return (0, _axios.default)({
            method: method,
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)(res.data.status, "Tour ".concat(type, " successfully!"));
            window.setTimeout(function () {
  ...
  return function manageTour(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.updateRole = exports.removeGuide = exports.deleteSetting = exports.addGuide = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          if (type === 'user') {
            ...
            url = "http://127.0.0.1:8000/api/v1/reviews/".concat(id);
            redirect = '/manage-reviews';
          } else if (type === 'tour') {
            url = "http://127.0.0.1:8000/api/v1/tours/".concat(id);
            redirect = '/manage-tours';
          } else if (type === 'booking') {
            url = "http://127.0.0.1:8000/api/v1/bookings/".concat(id);
        ...
        case 4:
          res = _context.sent;
          console.log(res);
          (0, _alerts.showAlert)('success', "Delete ".concat(type, " successfully!"));
          window.setTimeout(function () {
...
var updateRole = exports.updateRole = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userId, role) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "User's role updated to ".concat(role));
            window.setTimeout(function () {
...
var addGuide = exports.addGuide = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(tourId, guideId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8000/api/v1/tours/".concat(tourId, "/add-lead-guide"),
            data: {
              guideId: guideId
            }
          });
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Lead guide added!");
            window.setTimeout(function () {
              window.location.reload();
            }, 1500);
          }
  ...
  return function addGuide(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var removeGuide = exports.removeGuide = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(tourId, guideId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8000/api/v1/tours/".concat(tourId, "/remove-guide"),
            data: {
              guideId: guideId
            }
          });
        case 3:
          res = _context4.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Removed Successfully!");
            window.setTimeout(function () {
              window.location.reload();
            }, 1500);
          }
  ...
  return function removeGuide(_x7, _x8) {
...
exports.viewAllToursBtns = exports.searchUserFunc = exports.reviewSearchFunc = exports.removeGuideFunc = exports.deleteReviewFunc = exports.deleteFunc = exports.createTourFunc = exports.createReviewFunc = exports.confirmBookingFunc = exports.changeUserRoleFunc = exports.bookTourFunc = exports.addLocationAndDateFunc = exports.addGuideFunc = void 0;
var _stripe = require("./stripe");
var _bookingConfirm = require("./bookingConfirm");
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
// 1) TOUR-BOOKING
var bookTourFunc = exports.bookTourFunc = function bookTourFunc(bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var tourId = bookBtn.getAttribute('data-tourId');
...
// 2) // BOOKING-CONFIRM
var confirmBookingFunc = exports.confirmBookingFunc = function confirmBookingFunc(bookingSuccessContainer) {
  var tourData = JSON.parse(bookingSuccessContainer.getAttribute('data-tour'));
  var id = tourData.id;
  var selectedDate = tourData.selectedDate;
  (0, _bookingConfirm.bookingConfirm)(id, selectedDate);
};

// 3) CREATE-REVIEW
var createReviewFunc = exports.createReviewFunc = function createReviewFunc(reviewSubmitForm) {
  reviewSubmitForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var reviewId, type, tourId, review, selectedRating;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            reviewId = document.querySelector('.review-card-submit').getAttribute('data-reviewId');
            type = window.location.pathname.split('/')[1];
            tourId = document.querySelector('.review-card-form').getAttribute('data-tourId');
            review = document.querySelector('.review-card-textarea').value;
            selectedRating = document.querySelector('input[name="rating"]:checked').value;
            _context.next = 8;
            return (0, _manageReview.manageReview)(type, reviewId, tourId, selectedRating, review);
          case 8:
          case "end":
            return _context.stop();
        }
...
// DELETE-REVIEW
var deleteReviewFunc = exports.deleteReviewFunc = function deleteReviewFunc(reviewDeleteBtn) {
  reviewDeleteBtn.forEach(function (btn) {
      ...
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              reviewId = btn.getAttribute('data-reviewId');
              _context2.next = 4;
              return (0, _manageReview.deleteReview)(reviewId);
            case 4:
            case "end":
              return _context2.stop();
          }
...
var viewAllToursBtns = exports.viewAllToursBtns = function viewAllToursBtns() {
  var viewAllToursBtn = document.querySelector('.tour-admin-btn--list');
  var createTourForm = document.getElementById('createTourForm');
  var toursList = document.getElementById('toursList');
  if (viewAllToursBtn) {
    viewAllToursBtn.addEventListener('click', function () {
...
var addLocationAndDateFunc = exports.addLocationAndDateFunc = function addLocationAndDateFunc() {
  document.addEventListener('DOMContentLoaded', function () {
    var addDateBtn = document.querySelector(".tour-admin-btn--add[type='button']");
    var addLocationBtn = document.querySelectorAll(".tour-admin-btn--add[type='button']")[1];
    var tourDatesContainer = document.getElementById('tourDatesContainer');
    ...
    addDateBtn.addEventListener('click', function () {
      ...
      dateItem.id = "dateItem".concat(dateIndex);
      dateItem.innerHTML = "\n        <div class=\"tour-admin-form-row\">\n          <div class=\"tour-admin-form-group\">\n            <label class=\"tour-admin-form-label\" for=\"tourDate".concat(dateIndex, "\">Date</label>\n            <input class=\"tour-admin-form-input\" type=\"date\" id=\"tourDate").concat(dateIndex, "\" name=\"dates[").concat(dateIndex, "][date]\" required>\n          </div>\n          <div class=\"tour-admin-form-group\">\n            <label class=\"tour-admin-form-label\" for=\"tourParticipants").concat(dateIndex, "\">Participants</label>\n            <input class=\"tour-admin-form-input\" type=\"number\" id=\"tourParticipants").concat(dateIndex, "\" name=\"dates[").concat(dateIndex, "][participants]\" min=\"0\" value=\"0\">\n          </div>\n        </div>\n      ");
    ...
    addLocationBtn.addEventListener('click', function () {
      ...
      locationItem.id = "locationItem".concat(locationIndex);
      locationItem.innerHTML = "\n        <div class=\"tour-admin-form-row\">\n          <div class=\"tour-admin-form-group\">\n            <label class=\"tour-admin-form-label\" for=\"locationDay".concat(locationIndex, "\">Day</label>\n            <input class=\"tour-admin-form-input\" type=\"number\" id=\"locationDay").concat(locationIndex, "\" name=\"locations[").concat(locationIndex, "][day]\" min=\"1\" required>\n          </div>\n          <div class=\"tour-admin-form-group\">\n            <label class=\"tour-admin-form-label\" for=\"locationDescription").concat(locationIndex, "\">Description</label>\n            <input class=\"tour-admin-form-input\" type=\"text\" id=\"locationDescription").concat(locationIndex, "\" name=\"locations[").concat(locationIndex, "][description]\" required>\n          </div>\n        </div>\n        <div class=\"tour-admin-form-row\">\n          <div class=\"tour-admin-form-group\">\n            <label class=\"tour-admin-form-label\" for=\"locationLat").concat(locationIndex, "\">Latitude</label>\n            <input class=\"tour-admin-form-input\" type=\"number\" id=\"locationLat").concat(locationIndex, "\" name=\"locations[").concat(locationIndex, "][coordinates][1]\" step=\"any\" required>\n          </div>\n          <div class=\"tour-admin-form-group\">\n            <label class=\"tour-admin-form-label\" for=\"locationLng").concat(locationIndex, "\">Longitude</label>\n            <input class=\"tour-admin-form-input\" type=\"number\" id=\"locationLng").concat(locationIndex, "\" name=\"locations[").concat(locationIndex, "][coordinates][0]\" step=\"any\" required>\n          </div>\n        </div>\n      ");
      var removeBtn = document.createElement('button');
      removeBtn.classList.add('tour-admin-btn', 'tour-admin-btn--remove');
      removeBtn.textContent = 'Remove';
      removeBtn.type = 'button';
...
var createTourFunc = exports.createTourFunc = function createTourFunc(saveTourBtn, type) {
  saveTourBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var tourId, form, files, i, startLocation, tourDates, startDates, locations;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault(); // Prevent form from refreshing
            tourId = type === 'edit' ? tourIdsaveTourBtn.getAttribute('data-tourId') : '';
            form = new FormData(); // Collect form details automatically.
            ...
            startLocation = {
              ...
              coordinates: [parseFloat(document.getElementById('startLocationLng').value),
              // Longitude first
            ...
            tourDates = [];
            startDates = [];
            document.querySelectorAll('.tour-admin-date-item').forEach(function (item, index) {
              var dateInput = item.querySelector("input[name=\"dates[".concat(index, "][date]\"]"));
              var participantsInput = item.querySelector("input[name=\"dates[".concat(index, "][participants]\"]"));
            ...
            locations = [];
            document.querySelectorAll('.tour-admin-location-item').forEach(function (item, index) {
              var day = item.querySelector("input[name=\"locations[".concat(index, "][day]\"]"));
              var description = item.querySelector("input[name=\"locations[".concat(index, "][description]\"]"));
              var coordinates = [];
              var lat = item.querySelector("input[name=\"locations[".concat(index, "][coordinates][1]\"]")).value;
              var lng = item.querySelector("input[name=\"locations[".concat(index, "][coordinates][0]\"]")).value;
            ...
            _context3.next = 27;
            return (0, _manageTour.manageTour)(form, type, tourId);
          case 27:
          case "end":
            return _context3.stop();
        }
...
var searchUserFunc = exports.searchUserFunc = function searchUserFunc(searchInput) {
...
var deleteFunc = exports.deleteFunc = function deleteFunc(deleteButton, type) {
    ...
    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            e.preventDefault();
            id = deleteButton.getAttribute("data-".concat(type, "Id"));
            if (id) {
              _context4.next = 4;
              break;
            }
            return _context4.abrupt("return", alert("No ".concat(type, " id found!")));
          case 4:
            _context4.next = 6;
            return (0, _manageUser.deleteSetting)(id, type);
          case 6:
          case "end":
            return _context4.stop();
        }
...
var changeUserRoleFunc = exports.changeUserRoleFunc = function changeUserRoleFunc(changeRoleBtn) {
  changeRoleBtn.forEach(function (btn) {
    btn.addEventListener('click', /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
        var userId, row, roleSelect, newRole;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              e.preventDefault();
              // Get the user ID from the button attribute
              userId = btn.getAttribute('data-userId'); // Find the select dropdown inside the same row
              row = btn.closest('tr'); // Get the table row
              roleSelect = row.querySelector('.admin-user-role-select'); // Get the selected value
              newRole = roleSelect.value;
              _context5.next = 7;
              return (0, _manageUser.updateRole)(userId, newRole);
            case 7:
            case "end":
...
var addGuideFunc = exports.addGuideFunc = function addGuideFunc(btns, type) {
  btns.forEach(function (btn) {
    btn.addEventListener('click', /*#__PURE__*/function () {
      var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
        var selectLeadGuide, tourSection, tourId, guideId;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              e.preventDefault();
              // Find the closest tour section related to the clicked button
              tourSection = btn.closest('.admin-tour-detail-section'); // Get the correct tour ID from this section
              tourId = tourSection.querySelector('.tour-header').getAttribute('data-tourId'); // Get the selected guide ID from the dropdown inside this specific tour section
              if (type === 'lead-guide') {
                selectLeadGuide = tourSection.querySelector('.select-lead-guide');
              } else if (type === 'guide') {
                selectLeadGuide = tourSection.querySelector('.select-guide');
              }
              guideId = selectLeadGuide.value;
              console.log("guide ID:".concat(guideId, " | tour ID: ").concat(tourId));
              _context6.next = 8;
              return (0, _manageUser.addGuide)(tourId, guideId);
            case 8:
            case "end":
...
var removeGuideFunc = exports.removeGuideFunc = function removeGuideFunc(removeBtn) {
  removeBtn.forEach(function (btn) {
    btn.addEventListener('click', /*#__PURE__*/function () {
      var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(e) {
        var guideId, tourSection, tourId;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              e.preventDefault();
              guideId = btn.getAttribute('data-guideId');
              tourSection = btn.closest('.admin-tour-detail-section');
              tourId = tourSection.querySelector('.tour-header').getAttribute('data-tourId');
              console.log("GUIDE ID::".concat(guideId, " | TOUR ID::").concat(tourId));
              _context7.next = 7;
              return (0, _manageUser.removeGuide)(tourId, guideId);
            case 7:
            case "end":
...
var reviewSearchFunc = exports.reviewSearchFunc = function reviewSearchFunc(reviewSearchInp) {
  var reviewsContainer = document.querySelector('.admin-reviews-content');
  var reviewCards = document.querySelectorAll('.admin-reviews-user-group');
  var noReviewsMessage = reviewsContainer.querySelector('.admin-reviews-empty');
  if (!noReviewsMessage) {
  ...
  reviewSearchInp.addEventListener('input', function () {
    var searchValue = reviewSearchInp.value.toLowerCase().trim();
    var hasAnyResults = false;
    reviewCards.forEach(function (userGroup) {
      var hasMatch = false;
      userGroup.querySelectorAll('.admin-reviews-card').forEach(function (reviewCard) {
        var tourName = reviewCard.querySelector('.admin-reviews-tour-name a').textContent.toLowerCase();
        var reviewText = reviewCard.querySelector('.admin-reviews-text').textContent.toLowerCase();
        var userName = userGroup.querySelector('.admin-reviews-user-name').textContent.toLowerCase();
        if (userName.includes(searchValue) || tourName.includes(searchValue) || reviewText.includes(searchValue)) {
...
},{"./stripe":"stripe.js","./bookingConfirm":"bookingConfirm.js","./manageReview":"manageReview.js","./manageTour":"manageTour.js","./manageUser":"manageUser.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _resendMail = require("./resendMail");
...
var resendButton = document.querySelector('.resend-btn');
var bookBtn = document.querySelector('.tour-buy-button');
var bookingSuccessContainer = document.querySelector('.booking-success-container');
var reviewSubmitForm = document.querySelector('.review-card-form');
var reviewDeleteBtn = document.querySelectorAll('.btn-delete');
var tourAdminContainer = document.querySelector('.tour-admin-container');
var adminTourDeleteBtn = document.querySelectorAll('.admin-tour-delete-btn');
var saveTourBtn = document.querySelector('.tour-admin-btn--submit');
var editTourBtn = document.getElementById('edit-tour--btn');
var addBtns = document.querySelector('.tour-admin-btn--add');
var searchInput = document.querySelector('.admin-users-search-input');
var deleteButton = document.getElementById('confirm-delete');
var changeRoleBtn = document.querySelectorAll('.admin-update-btn');
var addLeadGuideBtn = document.querySelectorAll('.add-lead-guide-btn');
var addGuideBtn = document.querySelectorAll('.add-guide-btn');
var leadGuideRemoveBtn = document.querySelectorAll('.lead-guide-remove-btn');
var guideRemoveBtn = document.querySelectorAll('.guide-remove-btn');
var reviewSearchInp = document.querySelector('.admin-reviews-search-input');
var deleteBtnReview = document.getElementById('confirm-delete-review');
var deleteBookingsBtn = document.querySelectorAll('.bookings-management__delete-button');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    var form = new FormData(); // Collect form details automatically.
    form.append('name', document.getElementById('name').value); //.append() add key-value pairs to form
...
if (resendButton) {
  resendButton.addEventListener('click', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var email;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            email = resendButton.getAttribute('data-email'); // Get email from data attribute
            if (email) {
              _context3.next = 5;
              break;
            }
          ...
          case 5:
            _context3.next = 7;
            return (0, _resendMail.resendVerification)(email);
          case 7:
          case "end":
            return _context3.stop();
        }
